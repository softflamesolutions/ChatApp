package com.softflame.chatsapp.services;
...
import com.softflame.chatsapp.activities.ChatActivity;
...
import com.softflame.chatsapp.utils.FirebaseUploader;
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try {
                        ...
                        if (message != null && !message.getSenderId().equals(userMe.getId()) && !registeredChatUpdatedUserIds.contains(message.getSenderId())) {
                            ...
                            if (userInDb == null) {
                                User user = new User(message.getSenderId(), message.getSenderName(), message.getSenderStatus(), message.getSenderImage(),message.getRoll());
