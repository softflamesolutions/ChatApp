...
import com.softflame.chatsapp.models.LogCall;
import com.softflame.chatsapp.models.User;
import com.softflame.chatsapp.services.SinchService;
import com.softflame.chatsapp.utils.AudioPlayer;
...
public class CallScreenActivity extends BaseActivity implements SensorEventListener {
    ...
    private void endCall() {
        ...
        if (call != null) {
            if (user == null) {
                user = new User(call.getRemoteUserId(), call.getRemoteUserId(), getString(R.string.app_name), "",helper.getRoll());
            }
            call.hangup();
        }
        saveLog();
    ...
    private void saveLog() {
        if (!logSaved) {
            ...
            rChatDb.copyToRealm(new LogCall(user, System.currentTimeMillis(), mCallDurationSecond, isVideo, inOrOut, userMe.getId(),helper.getRoll()));
    ...
    private void addRemoteView() {
        ...
        if (vc != null) {
            ...
            RelativeLayout viewLocal = (RelativeLayout) findViewById(R.id.localVideo);
           // viewLocal.addView(vc.getLocalView());
