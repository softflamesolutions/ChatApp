...
import com.softflame.chatsapp.models.Country;
...
public class SignInActivity extends AppCompatActivity {
    private AppCompatSpinner spinnerCountryCodes,spinnerRoll;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {    //Check if user if logged in
            ...
            if (TextUtils.isEmpty(phoneNumberInPrefs)) {
                ...
                spinnerRoll = findViewById(R.id.sp_roll);
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    try {
                        ...
                        if (User.validate(user)) {
                            ...
                            createUser(new User(phoneNumberInPrefs, phoneNumberInPrefs, getString(R.string.app_name), "",helper.getRoll()));
                        }
                    } catch (Exception ex) {
                        createUser(new User(phoneNumberInPrefs, phoneNumberInPrefs, getString(R.string.app_name), "",helper.getRoll()));
                    }
    ...
    private void setupRoll() {
        ...
        //rolls.add("-- Select Gender --");
        rolls.add("Patient");
        rolls.add("Doctor");
        if (rolls != null) {
            ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(this, R.layout.item_roll_spinner, rolls);
            spinnerRoll.setAdapter(myAdapter);
        }
    }
...
//        return toReturn;
    ...
    public void submit() {
        ...
        if (spinnerCountryCodes.getSelectedItem() == null) {
            ...
            return;
        }if (spinnerRoll.getSelectedItem() == null) {
            Toast.makeText(this, R.string.validation_roll, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        final  String roll = spinnerRoll.getSelectedItem().toString();
