...
import com.softflame.chatsapp.adapters.GroupNewParticipantsAdapter;
import com.softflame.chatsapp.adapters.MediaSummaryAdapter;
import com.softflame.chatsapp.interfaces.OnUserDetailFragmentInteraction;
...
public class ChatDetailFragment extends Fragment implements GroupNewParticipantsAdapter.ParticipantClickListener {
    ...
    private void setParticipants() {
        ...
        for (MyString memberId : group.getUserIds()) {
            int pos = myUsers.indexOf(new User(memberId.getString(), "", "", "",helper.getRoll()));
            if (pos != -1)
    ...
    private void sortGroupUsers() {
        ...
        for (MyString userId : group.getUserIds()) {
            int index = groupUsers.indexOf(new User(userId.getString(), "", "", "",helper.getRoll()));
