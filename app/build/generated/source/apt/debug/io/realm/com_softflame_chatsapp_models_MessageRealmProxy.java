...
public class com_softflame_chatsapp_models_MessageRealmProxy extends com.softflame.chatsapp.models.Message
    implements RealmObjectProxy, com_softflame_chatsapp_models_MessageRealmProxyInterface {
    ...
    private ProxyState<com.softflame.chatsapp.models.Message> proxyState;
    private RealmList<com.softflame.chatsapp.models.MyString> recipientGroupIdsRealmList;

    com_softflame_chatsapp_models_MessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.softflame.chatsapp.models.Message>(this);
    ...
    public RealmList<com.softflame.chatsapp.models.MyString> realmGet$recipientGroupIds() {
        ...
        if (recipientGroupIdsRealmList != null) {
            ...
            recipientGroupIdsRealmList = new RealmList<com.softflame.chatsapp.models.MyString>(com.softflame.chatsapp.models.MyString.class, osList, proxyState.getRealm$realm());
            return recipientGroupIdsRealmList;
        }
    }
    ...
    public void realmSet$recipientGroupIds(RealmList<com.softflame.chatsapp.models.MyString> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.softflame.chatsapp.models.MyString> original = value;
                value = new RealmList<com.softflame.chatsapp.models.MyString>();
                for (com.softflame.chatsapp.models.MyString item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.softflame.chatsapp.models.MyString linkedObject = value.get(i);
    ...
    public com.softflame.chatsapp.models.Attachment realmGet$attachment() {
        ...
        return proxyState.getRealm$realm().get(com.softflame.chatsapp.models.Attachment.class, proxyState.getRow$realm().getLink(columnInfo.attachmentIndex), false, Collections.<String>emptyList());
    }
    ...
    @SuppressWarnings("cast")
    public static com.softflame.chatsapp.models.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        com.softflame.chatsapp.models.Message obj = realm.createObjectInternal(com.softflame.chatsapp.models.Message.class, true, excludeFields);

        final com_softflame_chatsapp_models_MessageRealmProxyInterface objProxy = (com_softflame_chatsapp_models_MessageRealmProxyInterface) obj;
        ...
        if (json.has("recipientGroupIds")) {
            if (json.isNull("recipientGroupIds")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.softflame.chatsapp.models.MyString item = com_softflame_chatsapp_models_MyStringRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        if (json.has("attachment")) {
            if (json.isNull("attachment")) {
                ...
                com.softflame.chatsapp.models.Attachment attachmentObj = com_softflame_chatsapp_models_AttachmentRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("attachment"), update);
    ...
    public static com.softflame.chatsapp.models.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.softflame.chatsapp.models.Message obj = new com.softflame.chatsapp.models.Message();
        final com_softflame_chatsapp_models_MessageRealmProxyInterface objProxy = (com_softflame_chatsapp_models_MessageRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$recipientGroupIds(new RealmList<com.softflame.chatsapp.models.MyString>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.softflame.chatsapp.models.MyString item = com_softflame_chatsapp_models_MyStringRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$recipientGroupIds().add(item);
                    }
                    reader.endArray();
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.softflame.chatsapp.models.Attachment attachmentObj = com_softflame_chatsapp_models_AttachmentRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$attachment(attachmentObj);
                }
            } else {
                reader.skipValue();
    ...
    public static com.softflame.chatsapp.models.Message copyOrUpdate(Realm realm, com.softflame.chatsapp.models.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.softflame.chatsapp.models.Message) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.softflame.chatsapp.models.Message copy(Realm realm, com.softflame.chatsapp.models.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.softflame.chatsapp.models.Message realmObject = realm.createObjectInternal(com.softflame.chatsapp.models.Message.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_softflame_chatsapp_models_MessageRealmProxyInterface realmObjectSource = (com_softflame_chatsapp_models_MessageRealmProxyInterface) newObject;
        com_softflame_chatsapp_models_MessageRealmProxyInterface realmObjectCopy = (com_softflame_chatsapp_models_MessageRealmProxyInterface) realmObject;
        ...
        realmObjectCopy.realmSet$roll(realmObjectSource.realmGet$roll());
        ...
        RealmList<com.softflame.chatsapp.models.MyString> recipientGroupIdsList = realmObjectSource.realmGet$recipientGroupIds();
        if (recipientGroupIdsList != null) {
            RealmList<com.softflame.chatsapp.models.MyString> recipientGroupIdsRealmList = realmObjectCopy.realmGet$recipientGroupIds();
            recipientGroupIdsRealmList.clear();
            for (int i = 0; i < recipientGroupIdsList.size(); i++) {
                com.softflame.chatsapp.models.MyString recipientGroupIdsItem = recipientGroupIdsList.get(i);
                com.softflame.chatsapp.models.MyString cacherecipientGroupIds = (com.softflame.chatsapp.models.MyString) cache.get(recipientGroupIdsItem);
                if (cacherecipientGroupIds != null) {
                    recipientGroupIdsRealmList.add(cacherecipientGroupIds);
                } else {
                    recipientGroupIdsRealmList.add(com_softflame_chatsapp_models_MyStringRealmProxy.copyOrUpdate(realm, recipientGroupIdsItem, update, cache));
                }
            }
        }
        ...
        com.softflame.chatsapp.models.Attachment attachmentObj = realmObjectSource.realmGet$attachment();
        if (attachmentObj == null) {
            realmObjectCopy.realmSet$attachment(null);
        } else {
            com.softflame.chatsapp.models.Attachment cacheattachment = (com.softflame.chatsapp.models.Attachment) cache.get(attachmentObj);
            if (cacheattachment != null) {
                realmObjectCopy.realmSet$attachment(cacheattachment);
            } else {
                realmObjectCopy.realmSet$attachment(com_softflame_chatsapp_models_AttachmentRealmProxy.copyOrUpdate(realm, attachmentObj, update, cache));
            }
        }
        return realmObject;
    }

    public static long insert(Realm realm, com.softflame.chatsapp.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.Message.class);
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.Message.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$senderName = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$senderName();
        ...
        String realmGet$senderImage = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$senderImage();
        ...
        String realmGet$senderStatus = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$senderStatus();
        ...
        String realmGet$recipientName = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$recipientName();
        ...
        String realmGet$recipientImage = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$recipientImage();
        ...
        String realmGet$recipientStatus = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$recipientStatus();
        ...
        String realmGet$roll = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$roll();
        if (realmGet$roll != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.rollIndex, rowIndex, realmGet$roll, false);
        }
        String realmGet$body = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$body();
        if (realmGet$body != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.bodyIndex, rowIndex, realmGet$body, false);
        }
        String realmGet$id = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id, false);
        }
        String realmGet$recipientId = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$recipientId();
        ...
        String realmGet$senderId = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$senderId();
        if (realmGet$senderId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.senderIdIndex, rowIndex, realmGet$senderId, false);
        }

        RealmList<com.softflame.chatsapp.models.MyString> recipientGroupIdsList = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$recipientGroupIds();
        if (recipientGroupIdsList != null) {
            OsList recipientGroupIdsOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.recipientGroupIdsIndex);
            for (com.softflame.chatsapp.models.MyString recipientGroupIdsItem : recipientGroupIdsList) {
                Long cacheItemIndexrecipientGroupIds = cache.get(recipientGroupIdsItem);
                if (cacheItemIndexrecipientGroupIds == null) {
                    cacheItemIndexrecipientGroupIds = com_softflame_chatsapp_models_MyStringRealmProxy.insert(realm, recipientGroupIdsItem, cache);
                }
                recipientGroupIdsOsList.addRow(cacheItemIndexrecipientGroupIds);
            }
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.dateIndex, rowIndex, ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$date(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.deliveredIndex, rowIndex, ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$delivered(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.sentIndex, rowIndex, ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$sent(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.attachmentTypeIndex, rowIndex, ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$attachmentType(), false);

        com.softflame.chatsapp.models.Attachment attachmentObj = ((com_softflame_chatsapp_models_MessageRealmProxyInterface) object).realmGet$attachment();
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_softflame_chatsapp_models_AttachmentRealmProxy.insert(realm, attachmentObj, cache);
            }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.Message.class);
        com.softflame.chatsapp.models.Message object = null;
        while (objects.hasNext()) {
            object = (com.softflame.chatsapp.models.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.softflame.chatsapp.models.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.Message.class);
        ...
        if (recipientGroupIdsList != null && recipientGroupIdsList.size() == recipientGroupIdsOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexrecipientGroupIds = cache.get(recipientGroupIdsItem);
                if (cacheItemIndexrecipientGroupIds == null) {
                    cacheItemIndexrecipientGroupIds = com_softflame_chatsapp_models_MyStringRealmProxy.insertOrUpdate(realm, recipientGroupIdsItem, cache);
                }
        ...
        if (attachmentObj != null) {
            Long cacheattachment = cache.get(attachmentObj);
            if (cacheattachment == null) {
                cacheattachment = com_softflame_chatsapp_models_AttachmentRealmProxy.insertOrUpdate(realm, attachmentObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.attachmentIndex, rowIndex, cacheattachment, false);
        } else {
    ...
    public static com.softflame.chatsapp.models.Message createDetachedCopy(com.softflame.chatsapp.models.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.softflame.chatsapp.models.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.softflame.chatsapp.models.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.softflame.chatsapp.models.Message) cachedObject.object;
            }
            unmanagedObject = (com.softflame.chatsapp.models.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_softflame_chatsapp_models_MessageRealmProxyInterface unmanagedCopy = (com_softflame_chatsapp_models_MessageRealmProxyInterface) unmanagedObject;
        com_softflame_chatsapp_models_MessageRealmProxyInterface realmSource = (com_softflame_chatsapp_models_MessageRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.softflame.chatsapp.models.MyString> managedrecipientGroupIdsList = realmSource.realmGet$recipientGroupIds();
            RealmList<com.softflame.chatsapp.models.MyString> unmanagedrecipientGroupIdsList = new RealmList<com.softflame.chatsapp.models.MyString>();
            ...
            for (int i = 0; i < size; i++) {
                com.softflame.chatsapp.models.MyString item = com_softflame_chatsapp_models_MyStringRealmProxy.createDetachedCopy(managedrecipientGroupIdsList.get(i), nextDepth, maxDepth, cache);
        ...
        unmanagedCopy.realmSet$attachment(com_softflame_chatsapp_models_AttachmentRealmProxy.createDetachedCopy(realmSource.realmGet$attachment(), currentDepth + 1, maxDepth, cache));
