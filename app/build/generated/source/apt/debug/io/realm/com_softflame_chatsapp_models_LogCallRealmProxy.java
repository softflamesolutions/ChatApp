...
public class com_softflame_chatsapp_models_LogCallRealmProxy extends com.softflame.chatsapp.models.LogCall
    implements RealmObjectProxy, com_softflame_chatsapp_models_LogCallRealmProxyInterface {
    ...
    private ProxyState<com.softflame.chatsapp.models.LogCall> proxyState;

    com_softflame_chatsapp_models_LogCallRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.softflame.chatsapp.models.LogCall>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("LogCall", 10, 0);
    ...
    @SuppressWarnings("cast")
    public static com.softflame.chatsapp.models.LogCall createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.softflame.chatsapp.models.LogCall obj = realm.createObjectInternal(com.softflame.chatsapp.models.LogCall.class, true, excludeFields);

        final com_softflame_chatsapp_models_LogCallRealmProxyInterface objProxy = (com_softflame_chatsapp_models_LogCallRealmProxyInterface) obj;
    ...
    public static com.softflame.chatsapp.models.LogCall createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.softflame.chatsapp.models.LogCall obj = new com.softflame.chatsapp.models.LogCall();
        final com_softflame_chatsapp_models_LogCallRealmProxyInterface objProxy = (com_softflame_chatsapp_models_LogCallRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.softflame.chatsapp.models.LogCall copyOrUpdate(Realm realm, com.softflame.chatsapp.models.LogCall object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.softflame.chatsapp.models.LogCall) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.softflame.chatsapp.models.LogCall copy(Realm realm, com.softflame.chatsapp.models.LogCall newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.softflame.chatsapp.models.LogCall realmObject = realm.createObjectInternal(com.softflame.chatsapp.models.LogCall.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_softflame_chatsapp_models_LogCallRealmProxyInterface realmObjectSource = (com_softflame_chatsapp_models_LogCallRealmProxyInterface) newObject;
        com_softflame_chatsapp_models_LogCallRealmProxyInterface realmObjectCopy = (com_softflame_chatsapp_models_LogCallRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.softflame.chatsapp.models.LogCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.LogCall.class);
        long tableNativePtr = table.getNativePtr();
        LogCallColumnInfo columnInfo = (LogCallColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.LogCall.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeDurationSecondsIndex, rowIndex, ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$timeDurationSeconds(), false);
        String realmGet$status = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$myId = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$userName = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameIndex, rowIndex, realmGet$userName, false);
        }
        String realmGet$userImage = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$userImage();
        ...
        String realmGet$userStatus = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$userStatus();
        ...
        String realmGet$roll = ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$roll();
        if (realmGet$roll != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.rollIndex, rowIndex, realmGet$roll, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVideoIndex, rowIndex, ((com_softflame_chatsapp_models_LogCallRealmProxyInterface) object).realmGet$isVideo(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        LogCallColumnInfo columnInfo = (LogCallColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.LogCall.class);
        com.softflame.chatsapp.models.LogCall object = null;
        while (objects.hasNext()) {
            object = (com.softflame.chatsapp.models.LogCall) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.softflame.chatsapp.models.LogCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.LogCall.class);
    ...
    public static com.softflame.chatsapp.models.LogCall createDetachedCopy(com.softflame.chatsapp.models.LogCall realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.softflame.chatsapp.models.LogCall unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.softflame.chatsapp.models.LogCall();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.softflame.chatsapp.models.LogCall) cachedObject.object;
            }
            unmanagedObject = (com.softflame.chatsapp.models.LogCall) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_softflame_chatsapp_models_LogCallRealmProxyInterface unmanagedCopy = (com_softflame_chatsapp_models_LogCallRealmProxyInterface) unmanagedObject;
        com_softflame_chatsapp_models_LogCallRealmProxyInterface realmSource = (com_softflame_chatsapp_models_LogCallRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_softflame_chatsapp_models_LogCallRealmProxy aLogCall = (com_softflame_chatsapp_models_LogCallRealmProxy)o;
