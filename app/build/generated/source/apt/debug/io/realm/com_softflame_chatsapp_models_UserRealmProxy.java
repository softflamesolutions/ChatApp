...
public class com_softflame_chatsapp_models_UserRealmProxy extends com.softflame.chatsapp.models.User
    implements RealmObjectProxy, com_softflame_chatsapp_models_UserRealmProxyInterface {
    ...
    private ProxyState<com.softflame.chatsapp.models.User> proxyState;

    com_softflame_chatsapp_models_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.softflame.chatsapp.models.User>(this);
    ...
    @SuppressWarnings("cast")
    public static com.softflame.chatsapp.models.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.softflame.chatsapp.models.User obj = null;
        if (update) {
            Table table = realm.getTable(com.softflame.chatsapp.models.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.User.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_softflame_chatsapp_models_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_softflame_chatsapp_models_UserRealmProxy) realm.createObjectInternal(com.softflame.chatsapp.models.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_softflame_chatsapp_models_UserRealmProxy) realm.createObjectInternal(com.softflame.chatsapp.models.User.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_softflame_chatsapp_models_UserRealmProxyInterface objProxy = (com_softflame_chatsapp_models_UserRealmProxyInterface) obj;
    ...
    public static com.softflame.chatsapp.models.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.softflame.chatsapp.models.User obj = new com.softflame.chatsapp.models.User();
        final com_softflame_chatsapp_models_UserRealmProxyInterface objProxy = (com_softflame_chatsapp_models_UserRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.softflame.chatsapp.models.User copyOrUpdate(Realm realm, com.softflame.chatsapp.models.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.softflame.chatsapp.models.User) cachedRealmObject;
        }

        com.softflame.chatsapp.models.User realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.softflame.chatsapp.models.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.User.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.User.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_softflame_chatsapp_models_UserRealmProxy();
    ...
    public static com.softflame.chatsapp.models.User copy(Realm realm, com.softflame.chatsapp.models.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.softflame.chatsapp.models.User realmObject = realm.createObjectInternal(com.softflame.chatsapp.models.User.class, ((com_softflame_chatsapp_models_UserRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_softflame_chatsapp_models_UserRealmProxyInterface realmObjectSource = (com_softflame_chatsapp_models_UserRealmProxyInterface) newObject;
        com_softflame_chatsapp_models_UserRealmProxyInterface realmObjectCopy = (com_softflame_chatsapp_models_UserRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.softflame.chatsapp.models.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$nameInPhone = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$nameInPhone();
        ...
        String realmGet$name = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$name();
        if (realmGet$name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.nameIndex, rowIndex, realmGet$name, false);
        }
        String realmGet$status = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$image = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$image();
        if (realmGet$image != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.imageIndex, rowIndex, realmGet$image, false);
        }
        String realmGet$roll = ((com_softflame_chatsapp_models_UserRealmProxyInterface) object).realmGet$roll();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.User.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.softflame.chatsapp.models.User object = null;
        while (objects.hasNext()) {
            object = (com.softflame.chatsapp.models.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.softflame.chatsapp.models.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.User.class);
    ...
    public static com.softflame.chatsapp.models.User createDetachedCopy(com.softflame.chatsapp.models.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.softflame.chatsapp.models.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.softflame.chatsapp.models.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.softflame.chatsapp.models.User) cachedObject.object;
            }
            unmanagedObject = (com.softflame.chatsapp.models.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_softflame_chatsapp_models_UserRealmProxyInterface unmanagedCopy = (com_softflame_chatsapp_models_UserRealmProxyInterface) unmanagedObject;
        com_softflame_chatsapp_models_UserRealmProxyInterface realmSource = (com_softflame_chatsapp_models_UserRealmProxyInterface) realmObject;
    ...
    static com.softflame.chatsapp.models.User update(Realm realm, com.softflame.chatsapp.models.User realmObject, com.softflame.chatsapp.models.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_softflame_chatsapp_models_UserRealmProxyInterface realmObjectTarget = (com_softflame_chatsapp_models_UserRealmProxyInterface) realmObject;
        com_softflame_chatsapp_models_UserRealmProxyInterface realmObjectSource = (com_softflame_chatsapp_models_UserRealmProxyInterface) newObject;
        ...
        realmObjectTarget.realmSet$roll(realmObjectSource.realmGet$roll());
        return realmObject;
    }
