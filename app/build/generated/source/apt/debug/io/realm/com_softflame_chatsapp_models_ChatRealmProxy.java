...
public class com_softflame_chatsapp_models_ChatRealmProxy extends com.softflame.chatsapp.models.Chat
    implements RealmObjectProxy, com_softflame_chatsapp_models_ChatRealmProxyInterface {
    ...
    private ProxyState<com.softflame.chatsapp.models.Chat> proxyState;
    private RealmList<com.softflame.chatsapp.models.Message> messagesRealmList;

    com_softflame_chatsapp_models_ChatRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.softflame.chatsapp.models.Chat>(this);
    ...
    @Override
    public RealmList<com.softflame.chatsapp.models.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.softflame.chatsapp.models.Message>(com.softflame.chatsapp.models.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }

    @Override
    public void realmSet$messages(RealmList<com.softflame.chatsapp.models.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.softflame.chatsapp.models.Message> original = value;
                value = new RealmList<com.softflame.chatsapp.models.Message>();
                for (com.softflame.chatsapp.models.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.softflame.chatsapp.models.Message linkedObject = value.get(i);
    ...
    @SuppressWarnings("cast")
    public static com.softflame.chatsapp.models.Chat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("messages")) {
            excludeFields.add("messages");
        }
        com.softflame.chatsapp.models.Chat obj = realm.createObjectInternal(com.softflame.chatsapp.models.Chat.class, true, excludeFields);

        final com_softflame_chatsapp_models_ChatRealmProxyInterface objProxy = (com_softflame_chatsapp_models_ChatRealmProxyInterface) obj;
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.softflame.chatsapp.models.Message item = com_softflame_chatsapp_models_MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.softflame.chatsapp.models.Chat createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.softflame.chatsapp.models.Chat obj = new com.softflame.chatsapp.models.Chat();
        final com_softflame_chatsapp_models_ChatRealmProxyInterface objProxy = (com_softflame_chatsapp_models_ChatRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.softflame.chatsapp.models.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.softflame.chatsapp.models.Message item = com_softflame_chatsapp_models_MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.softflame.chatsapp.models.Chat copyOrUpdate(Realm realm, com.softflame.chatsapp.models.Chat object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.softflame.chatsapp.models.Chat) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.softflame.chatsapp.models.Chat copy(Realm realm, com.softflame.chatsapp.models.Chat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.softflame.chatsapp.models.Chat realmObject = realm.createObjectInternal(com.softflame.chatsapp.models.Chat.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_softflame_chatsapp_models_ChatRealmProxyInterface realmObjectSource = (com_softflame_chatsapp_models_ChatRealmProxyInterface) newObject;
        com_softflame_chatsapp_models_ChatRealmProxyInterface realmObjectCopy = (com_softflame_chatsapp_models_ChatRealmProxyInterface) realmObject;


        RealmList<com.softflame.chatsapp.models.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.softflame.chatsapp.models.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.softflame.chatsapp.models.Message messagesItem = messagesList.get(i);
                com.softflame.chatsapp.models.Message cachemessages = (com.softflame.chatsapp.models.Message) cache.get(messagesItem);
                if (cachemessages != null) {
                    messagesRealmList.add(cachemessages);
                } else {
                    messagesRealmList.add(com_softflame_chatsapp_models_MessageRealmProxy.copyOrUpdate(realm, messagesItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.softflame.chatsapp.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.Chat.class);
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.Chat.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<com.softflame.chatsapp.models.Message> messagesList = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.softflame.chatsapp.models.Message messagesItem : messagesList) {
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_softflame_chatsapp_models_MessageRealmProxy.insert(realm, messagesItem, cache);
                }
                messagesOsList.addRow(cacheItemIndexmessages);
            }
        }
        String realmGet$lastMessage = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$chatId = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdIndex, rowIndex, realmGet$chatId, false);
        }
        String realmGet$chatName = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$chatName();
        if (realmGet$chatName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatNameIndex, rowIndex, realmGet$chatName, false);
        }
        String realmGet$chatImage = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$chatImage();
        ...
        String realmGet$chatStatus = ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$chatStatus();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$read(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.groupIndex, rowIndex, ((com_softflame_chatsapp_models_ChatRealmProxyInterface) object).realmGet$group(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(com.softflame.chatsapp.models.Chat.class);
        com.softflame.chatsapp.models.Chat object = null;
        while (objects.hasNext()) {
            object = (com.softflame.chatsapp.models.Chat) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.softflame.chatsapp.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.softflame.chatsapp.models.Chat.class);
        ...
        if (messagesList != null && messagesList.size() == messagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_softflame_chatsapp_models_MessageRealmProxy.insertOrUpdate(realm, messagesItem, cache);
                }
    ...
    public static com.softflame.chatsapp.models.Chat createDetachedCopy(com.softflame.chatsapp.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.softflame.chatsapp.models.Chat unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.softflame.chatsapp.models.Chat();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.softflame.chatsapp.models.Chat) cachedObject.object;
            }
            unmanagedObject = (com.softflame.chatsapp.models.Chat) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_softflame_chatsapp_models_ChatRealmProxyInterface unmanagedCopy = (com_softflame_chatsapp_models_ChatRealmProxyInterface) unmanagedObject;
        com_softflame_chatsapp_models_ChatRealmProxyInterface realmSource = (com_softflame_chatsapp_models_ChatRealmProxyInterface) realmObject;

        // Deep copy of messages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$messages(null);
        } else {
            RealmList<com.softflame.chatsapp.models.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.softflame.chatsapp.models.Message> unmanagedmessagesList = new RealmList<com.softflame.chatsapp.models.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.softflame.chatsapp.models.Message item = com_softflame_chatsapp_models_MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
    ...
    public boolean equals(Object o) {
        ...
        com_softflame_chatsapp_models_ChatRealmProxy aChat = (com_softflame_chatsapp_models_ChatRealmProxy)o;
